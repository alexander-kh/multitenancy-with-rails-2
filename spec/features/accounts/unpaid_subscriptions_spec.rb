...
RSpec.feature "Unpaid subscriptions" do
  let(:account) do
    FactoryBot.create(:account, :subscribed,
  ...
  context "a user for the account" do
    ...
    it "cannot access the account's books" do
      ...
      expect(page).to have_content(
        "This account is currently disabled due to an unpaid subscription.")
  ...
  context "the owner of the account" do
    ...
    it "cannot add a new book to the account" do
      ...
      expect(page).to have_content("This account is currently disabled due to\
        an unpaid subscription.")
      expect(page).to have_content("Please update your payment details to\
